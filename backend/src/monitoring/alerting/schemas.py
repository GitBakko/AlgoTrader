...
ALERT_EMOJI: dict[str, str] = {
    ...
    AlertType.TRAINING_STARTED: "🧠",  # brain — model learning
    AlertType.TRAINING_COMPLETE: "🎓",  # graduation cap — training done
    AlertType.TRAINING_FAILED: "💔",  # broken heart — training failed
}
