...
_MODEL_REGISTRY = [
    ...
    {
        "id": "xgboost-usdchf-v1",
        "name": "XGBoost USD/CHF",
        "type": "xgboost",
        "epic": "USDCHF",
        "status": "untrained",
        "accuracy": 0.0,
    ...
    {
        "id": "xgboost-usdcad-v1",
        "name": "XGBoost USD/CAD",
        "type": "xgboost",
        "epic": "USDCAD",
        "status": "untrained",
        "accuracy": 0.0,
    ...
    {
        "id": "xgboost-audusd-v1",
        "name": "XGBoost AUD/USD",
        "type": "xgboost",
        "epic": "AUDUSD",
        "status": "untrained",
        "accuracy": 0.0,
    ...
    {
        "id": "xgboost-nzdusd-v1",
        "name": "XGBoost NZD/USD",
        "type": "xgboost",
        "epic": "NZDUSD",
        "status": "untrained",
        "accuracy": 0.0,
    ...
    {
        "id": "xgboost-eurjpy-v1",
        "name": "XGBoost EUR/JPY",
        "type": "xgboost",
        "epic": "EURJPY",
        "status": "untrained",
        "accuracy": 0.0,
